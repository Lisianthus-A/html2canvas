            ...
            return __generator(this, function (_a) {
                ...
                paths.forEach(function (point, index) {
                    ...
                    if (index === 2) {
                        ...
                        _this.ctx.strokeStyle = color_1.asString(color);
                    }
                    if (cur) {
                    ...
                    _this.ctx.stroke();
                    _this.ctx.closePath();
                    cur = bezier_curve_1.isBezierCurve(point) ? point.start : point;
                });
                return [2 /*return*/];
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3:
                        if (!(_i < borders_1.length)) return [3 /*break*/, 14];
                        border = borders_1[_i];
                        if (!(border.style !== border_style_1.BORDER_STYLE.NONE && !color_1.isTransparent(border.color))) return [3 /*break*/, 12];
    ...
    CanvasRenderer.prototype.renderDottedBorder = function (color, side, curvePoints) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                border_1.renderDottedLine(x1, y1, x2, y2, interval, this.ctx, color_1.asString(color), offset);
                return [2 /*return*/];
            });
        });
    };
